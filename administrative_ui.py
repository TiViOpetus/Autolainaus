...
"color: rgb(255, 255, 255);")
        ...
        self.saveVehiclePushButton.setGeometry(QRect(300, 200, 101, 25))
...
"color: rgb(255, 255, 255);")
        ...
        if (self.vehicleCatalogTableWidget.rowCount() < 8):
            self.vehicleCatalogTableWidget.setRowCount(8)
        ...
        self.vehicleListLabel.setGeometry(QRect(530, 220, 101, 16))
        ...
        self.vehiclePictureLabel.setGeometry(QRect(410, 0, 331, 211))
